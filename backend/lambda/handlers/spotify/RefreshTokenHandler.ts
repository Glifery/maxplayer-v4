 ...
 */
export class RefreshTokenHandler implements HandlerInterface {
    handle (event: HttpRequest, context: Context, callback: Callback): null {
        this.resolveDynamoDbInstance();
        ...
        const tokenManager = new TokenManager(
            ...
            new DynamoDbTokenRepository(dynamoDb, {
    ...
    private resolveDynamoDbInstance(): void {
